...
#define PICKUP_ON_BUTTON		6
#define PICKUP_REVERSE_BUTTON   7

#define SHOOTER_TOP_HEIGHT_BUTTON	11
#define SHOOTER_MID_HEIGHT_BUTTON	10
#define SHOOTER_LOAD_HEIGHT_BUTTON	6
#define SHOOTER_LOAD_HEIGHT_BUTTON1	8
#define SHOOTER_LOAD_HEIGHT_BUTTON2	9

#define CAMERA_SNAPSHOT_BUTTON 9

#define CLIMB_BUTTON 4
